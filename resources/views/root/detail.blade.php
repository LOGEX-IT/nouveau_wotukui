                    ...
                    <div class="header-bottom">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="{{ url('/') }}"><img
                                            src="{{ asset('template/assets/images/about/wotukui.png') }}"
                                            alt="logo"></a>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-7">
                                <div class="main-menu main-menu-padding-1 main-menu-lh-1">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a
                                                    href="{{ url('/categorie/2') }}">{{ __('Meubles de bureau') }}</a>
                                            </li>
                            ...
                            <div class="col-7">
                                <div class="header-action header-action-flex">
                                    ...
                                    <div class="same-style-2 same-style-2-white main-menu-icon">
                                        <a class="mobile-header-button-active" href="{{ asset('/') }}"><i
                                                class="icon-menu"></i> </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="easyzoom-style">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset($detail_produit->photo) }}" alt="">
                                        </a>
                                    </div>
                                    <a class="easyzoom-pop-up img-popup" href="{{ asset($detail_produit->photo) }}"><i
                                            class="icon-size-fullscreen"></i></a>
                                </div>
                                <div class="easyzoom-style">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="{{ asset($detail_produit->photo) }}">
                                            <img src="{{ asset($detail_produit->photo) }}" alt="">
                                        </a>
                                    </div>
                                    <a class="easyzoom-pop-up img-popup" href="{{ asset($detail_produit->photo) }}"><i
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product-details-content pro-details-content-mrg">
                            ...
                            <div class="product-ratting-review-wrap">
                                ...
                                {{-- <input type="hidden" name="produit_id" value="{{ $detail_produit->id }}" /> --}}
                                <p>{{ $detail_produit->description }}</p><hr>
                                <div class="pro-details-price">
                                    <span class="new-price">{{ number_format($detail_produit->price, 2) }}
                                        FCFA</span>
                                </div>
                        </div>  
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="footer-widget mb-40">
                            ...
                            <div class="footer-info-list info-list-50-parcent">
                                <ul>
                                    <img src="{{ asset('template/assets/images/about/wotukui.png') }}" width="200px"
                                        height="81" alt=""><br>
                            ...
                            <div class="contact-info-2">
                                <div class="single-contact-info-2">
                                    ...
                                    <div class="contact-info-2-content">
                                        <p>Appelez nous</p>
                                        <h3 class="blue" style="color: #0d47a1 !important">(228) 93 05 53 53
                                        </h3>
                                        <h3 class="blue" style="color: #0d47a1 !important">(228) 96 05 53 53
                                        </h3>
                                    </div>
                                </div>
                                <div class="single-contact-info-2">
                ...
                <div class="row flex-row-reverse">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright copyright-center">
                            <p>&copy; Copyright 2008-2021 - Tous drois réservés | Conçu par <a
                                    href="http://logexit.com/">LOGEX</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
