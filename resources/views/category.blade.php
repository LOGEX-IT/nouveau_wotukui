...
<body>
    <input type="hidden" id="element" value="{{$page_recherche}}">
...
<div class="shop-area pt-120 pb-120">
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                {{--
                <div class="shop-bottom-area" id="default">
                ...
                <div class="sidebar-wrapper sidebar-wrapper-mrg-right">
                    <div class="sidebar-widget mb-40">
                        ...
                        <div class="sidebar-search">
                            <form class="sidebar-search-form" action="javascript:void(0)">
                                <input id="recherche" type="text" autocomplete="off" placeholder="Rechercher un produit...">
                                <button>
                    ...
                    <div class="sidebar-widget shop-sidebar-border mb-35 pt-40">
                        ...
                        <div class="shop-catigory">
                            <ul>
                                ...
                                <li><a href="{{url('/categorie/2')}}">{{ __('Meubles de bureau') }}</a></li>
                                <li><a href="{{url('/categorie/3')}}">{{ __('Electroménager') }}</a></li>
                                <li><a href="{{url('/categorie/4')}}">Auto-Moto</a></li>
                                <li><a href="{{url('/categorie/5')}}">TIC </a></li>
                                <li><a href="{{url('/categorie/6')}}">Made In Africa</a></li>
                            </ul>
