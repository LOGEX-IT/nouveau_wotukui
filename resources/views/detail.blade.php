        ...
        <div class="row">
                ...
                <div class="product-details-tab">
                    <div class="pro-dec-big-img-slider">
                        <div class="easyzoom-style">
                            ...
                            <a class="easyzoom-pop-up img-popup" href="{{asset($detail_produit->photo)}}"><i class="icon-size-fullscreen"></i></a>
                        </div>
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product-details-content pro-details-content-mrg">
                    ...
                    <p>{{ $detail_produit->description }}</p>
                    <div class="pro-details-price">
                        <span class="new-price">{{ number_format($detail_produit->price,0,",",".")  }} FCFA</span>
                        <!-- <span class="old-price">$95.72</span> -->
                    </div>
                    <div class="pro-details-quality">
                        <span>Quantité:</span>
                        <div class="cart-plus-minus">
                            <input class="cart-plus-minus-box" type="" name="qtybutton" value="1">
                        </div>
                    </div>
                    <div class="pro-details-action-wrap">
                        <div class="pro-details-add-to-cart">
                            <input class="button" name="" title="Ajouter au panier" type="submit" value="Ajouter au panier"> 
                        </div>
